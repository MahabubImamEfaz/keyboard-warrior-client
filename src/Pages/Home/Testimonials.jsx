    ...
    <div>
      <section className="my-8 bg-gray-800 text-gray-100">
        <div className="container flex flex-col items-center mx-auto mb-12 md:p-10 md:px-12">
          <h1 className="p-4 text-4xl font-semibold leading-none text-center text-[#e9c46a]">
        ...
        <div className="container flex flex-col items-center justify-center mx-auto lg:flex-row lg:flex-wrap lg:justify-evenly lg:px-10">
          <div className="flex flex-col max-w-sm mx-4 my-6 shadow-lg">
            <div className="px-4 py-12 rounded-t-lg sm:px-8 md:px-12 bg-gray-900">
              <p className="relative px-6 py-1 text-lg italic text-center text-gray-100">
                ...
                <svg
                  ...
                  viewBox="0 0 512 512"
                  fill="currentColor"
                  className="absolute right-0 w-8 h-8 text-[#e9c46a]"
                >
            ...
            <div className="flex flex-col items-center justify-center p-8 rounded-b-lg bg-[#e9c46a] text-gray-900">
              <img
